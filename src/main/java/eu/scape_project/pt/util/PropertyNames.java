...
public class PropertyNames {
    ...
    public static final String INPUTFORMAT_CLASS = "mapreduce.job.inputformat.class";
    public static final String INFILE = "mapreduce.input.fileinputformat.inputdir";
